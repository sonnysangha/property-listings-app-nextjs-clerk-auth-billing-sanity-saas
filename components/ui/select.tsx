...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        // Base styles
        "flex w-fit items-center justify-between gap-2 rounded-lg border-2 border-border bg-background px-4 py-2 text-sm whitespace-nowrap shadow-xs",
        ...
        // Dark mode
        "dark:bg-card dark:border-border dark:hover:bg-accent/30",
        // Hover
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "bg-popover text-popover-foreground relative z-50 max-h-(--radix-select-content-available-height) min-w-[8rem] origin-(--radix-select-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-xl border border-border/50 shadow-warm-lg",
          // Animations
