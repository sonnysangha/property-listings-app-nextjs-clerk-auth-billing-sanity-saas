...
export async function generateMetadata({
  ...
  return {
    ...
    description: property.description?.slice(0, 160) || `Beautiful ${property.propertyType || "property"} with ${property.bedrooms} bedrooms and ${property.bathrooms} bathrooms.`,
  };
}
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {property.description && (
              <Card className="shadow-warm">
                <CardHeader>
                  <CardTitle className="font-heading">About This Property</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            {property.amenities && property.amenities.length > 0 && (
              <Card className="shadow-warm">
                <CardHeader>
                  <CardTitle className="font-heading">Amenities & Features</CardTitle>
                </CardHeader>
                <CardContent>
